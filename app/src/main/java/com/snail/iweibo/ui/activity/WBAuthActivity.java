...
public class WBAuthActivity extends AppCompatActivity implements View.OnClickListener{

    @Bind(R.id.obtain_token_via_web)Button button;

    /** 显示认证后的信息，如 AccessToken */
    @Bind(R.id.token_text_view) TextView mTokenText;
