...
import com.snail.iweibo.ui.activity.FollowersActivity;
 ...
 */
public class IUserDetailActivity implements IBaseView, OnClickListener {
    private View view;
    ...
    public void updateView(UserBean userBean) {
        ...
        SharePreferencesUtil.setUserBean(context,userBean);
